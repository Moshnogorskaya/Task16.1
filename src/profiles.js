...
function createSuggestionStreamDetails(suggestionStream) {
  return suggestionStream.mergeMap(suggestedUser =>
...
createSuggestionStreamDetails(suggestion1Stream).subscribe(suggestedUser =>
  renderSuggestion(suggestedUser, '.suggestion-1'));
createSuggestionStreamDetails(suggestion2Stream).subscribe(suggestedUser =>
  renderSuggestion(suggestedUser, '.suggestion-2'));
createSuggestionStreamDetails(suggestion3Stream).subscribe(suggestedUser =>
